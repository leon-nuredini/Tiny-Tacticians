...
namespace TbsFramework.Cells
{
    ...
    {
        int                                                hash = -1;
        [HideInInspector] [SerializeField] private Vector2 _offsetCoord;
        ...
        [BoxGroup("Highlight")] public List<CellHighlighter> MarkAsReachableFn;
        [BoxGroup("Highlight")] public List<CellHighlighter> MarkAsPathFn;
        [BoxGroup("Highlight")] public List<CellHighlighter> MarkAsHighlightedFn;
        [BoxGroup("Highlight")] public List<CellHighlighter> UnMarkFn;

        public bool IsMarkedReachable;
        ...
        /// </summary>
        public virtual void MarkAsHighlighted() { MarkAsHighlightedFn?.ForEach(o => o.Apply(this)); }
        ...
        public override bool Equals(object other)
        {
            ...
            return otherCell     != null && OffsetCoord.x == otherCell.OffsetCoord.x &&
                   OffsetCoord.y == otherCell.OffsetCoord.y;
        }
        ...
        public override string ToString() { return OffsetCoord.ToString(); }
    }
}